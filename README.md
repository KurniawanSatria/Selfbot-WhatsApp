...
Class **builder pattern** untuk membangun dan mengirim *interactive message* (native flow) dengan API method-chaining.
...
const rich = new AIRich(sock)
  ...
  .addCode("javascript", "function factorial(n) {\n  return n <= 1 ? 1 : n * factorial(n - 1);\n}")
  .addTable([
    ["Bahasa", "Tipe"],
    ["JavaScript", "Dynamic"],
    ["Rust", "Static"]
...
const url = await Toolkit.resolveMedia(sock, "https://contoh.com/gambar.jpg", "image", {
  resolveUrl: true,
  result: "url"
});
```
