...
async function imageToWebp(media) {
  ...
  return runFfmpeg(tmpIn, tmpOut, [
    ...
    "1",
    "-vf",
    "format=rgba,scale='min(320,iw)':'min(320,ih)':force_original_aspect_ratio=decrease,fps=15,pad=320:320:-1:-1:color=black@0.0",
  ]);
}
...
async function writeExifImg(media, metadata) {
  ...
  if (metadata.packname || metadata.author) {
    ...
    const json = {
      publisher_website: "https://satzzdev.xyz",
      "sticker-pack-id": `https://satzzdev.xyz`,
